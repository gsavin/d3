...
public class D3HTTP
	implements Feature, HttpHandler
{
	/**
	 * Description of this feature.
	 */
	protected static final FeatureDescription httpDescription =
		new FeatureDescription( "l2d.features.http", "HTTP Server", "" );
	...
	public void handle(HttpExchange arg0)
		throws IOException
	{
		String response = getL2DH( "org/ri2c/l2d/agency/feature/http/content.l2dh" );
	...
	protected  String getL2DH( String l2dh )
		throws IOException
	{
		...
		while( in.available() > 0 )
		{
			...
			if( c == '$' )
			{
				...
				else out.append( "unknown csname" );
			}
	...
	protected String agenciesList()
	{
		...
		for( RemoteAgencyDescription rad: Agency.getLocalAgency().eachRemoteAgency() )
			...
			.append(rad.getId())
			.append("&nbsp;@&nbsp;")
			.append(rad.getAddress())
			.append("&nbsp;:&nbsp;")
			.append(rad.getFirstProtocol())
			.append("</li>");
